<!--
=====================================================================
 README DE PERFIL — VERSIÓN EXPLORATORIA
=====================================================================
 INSTRUCCIONES:
 ...
 3. Los "themes" (temas de color) se pueden cambiar en casi todos
    los widgets con el parámetro &theme=  (radical, dark, tokyonight,
    dracula, gruvbox, merko, onedark, cobalt, etc.)
=====================================================================
-->


<!-- ================================================================
 1) HEADER TIPO "WAVE" (capsule-render)
    Banner animado en la parte superior. Cambia:
      type=   -> waving, wave, egg, shark, slice, rect, cylinder, soft
      color=  -> gradient, o un hex sin '#', ej: 0:00FF00,100:0000FF
...
<!-- ================================================================
 2) TÍTULO CON TYPING SVG (efecto máquina de escribir)
...
<!-- ================================================================
 3) CONTADOR DE VISITAS (profile-views-counter)
...
<!-- ================================================================
 4) SECCIÓN "SOBRE MÍ" (texto normal en markdown)
...
<!-- ================================================================
 5) BADGES DE REDES SOCIALES (shields.io)
    Cada badge es una imagen enlazada. Cambia el color, el logo y la URL.
    Busca más logos en: https://simpleicons.org
=================================================================== -->
## 🌐 Encuéntrame en
...
<!-- ================================================================
 6) STACK DE TECNOLOGÍAS — OPCIÓN A: shields.io (badges individuales)
    Control total sobre cada badge. Cambia logo, color y texto.
=================================================================== -->
## 🛠️ Tecnologías (opción A: badges shields.io)
...
<!-- ================================================================
 6b) STACK DE TECNOLOGÍAS — OPCIÓN B: skill-icons (íconos limpios)
    Más rápido de escribir: pones los íconos separados por coma.
    Lista completa: https://github.com/tandpfun/skill-icons
    theme=dark o theme=light
=================================================================== -->
## 🛠️ Tecnologías (opción B: skill-icons)

<p align="center">
  <img src="https://skillicons.dev/icons?i=js,ts,python,react,nodejs,docker,git,linux,vscode&theme=dark" />
</p>


<!-- ================================================================
 7) ESTADÍSTICAS DE GITHUB (github-readme-stats)
    La tarjeta más popular. Muestra commits, PRs, issues, estrellas.
    IMPORTANTE: para contar contribuciones privadas necesitas
    desplegar tu propia instancia (opcional).
=================================================================== -->
...
<!-- ================================================================
 8) RACHA DE CONTRIBUCIONES (github-readme-streak-stats)
    Días seguidos contribuyendo, racha más larga, total.
=================================================================== -->
...
<!-- ================================================================
 9) TROFEOS (github-profile-trophy)
    Medallas visuales según tus stats. column= controla cuántos por fila.
=================================================================== -->
## 🏆 Trofeos
...
<!-- ================================================================
 10) TARJETAS RESUMEN (github-profile-summary-cards)
    Set de 5 tarjetas: lenguajes, actividad, commits por hora/día, etc.
=================================================================== -->
## 📈 Tarjetas resumen
...
<!-- ================================================================
 11) SNAKE ANIMATION (Platane/snk)
    La víbora que se come tu gráfico de contribuciones.
    OJO: esto NO funciona con solo pegar la URL. Requiere configurar
    un GitHub Action que genere el SVG. La URL de abajo apunta a la
    rama 'output' que crea ese Action. Instrucciones más abajo (*).
=================================================================== -->
...
<!-- ================================================================
 12) GITHUB METRICS (lowlighter/metrics) — opcional / avanzado
    Infografía enorme con 30+ plugins. También requiere GitHub Action.
    Aquí solo dejo el hueco donde iría la imagen generada.
=================================================================== -->
<!--
<p align="center">
...
<!-- ================================================================
 13) CITA / QUOTE DINÁMICA (github-readme-quotes)
    Muestra una frase aleatoria de programación cada vez que se carga.
=================================================================== -->
## 💭 Frase del día
...
<!-- ================================================================
 14) FOOTER TIPO "WAVE" (capsule-render de nuevo, section=footer)
=================================================================== -->
<p align="center">
...
<!--
=====================================================================
 (*) NOTAS SOBRE LOS WIDGETS QUE NECESITAN GITHUB ACTIONS
=====================================================================
 La mayoría de los widgets de arriba funcionan con solo pegar la URL
 (son imágenes que se generan al vuelo). PERO estos dos NO:
 ...
 TEMAS DE COLOR disponibles en muchos widgets (&theme=):
